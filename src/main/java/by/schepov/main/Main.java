...
import by.schepov.exception.ExpressionParserException;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try {
            System.out.println("replacing expressions____________________________________________");
            String newText = ExpressionParser.parseAndReplaceMathExpressions(initialText);
            System.out.println(newText);
            Parser textParser = createParser();
            TextComponent textComponent = textParser.parse(newText);
            System.out.println("parsing_________________________________________________");
